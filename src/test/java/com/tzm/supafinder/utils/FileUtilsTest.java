...
class FileUtilsTest {
    ...
    void testExportRegexListToJSON() {
        ...
        assertThat(FileUtils.exportRegexListToJson(regexes, true)).isEqualTo(
                "[{\"active\":true,\"description\":\"Test regex 1\",\"regex\":\"-----BEGIN\",\"importance\":2,\"sections\":[\"req_body\",\"res_headers\",\"res_body\"]},{\"active\":false,\"description\":\"Test regex 2\",\"regex\":\"-----BEGIN\",\"importance\":2,\"refinerRegex\":\".+$\",\"sections\":[\"res_headers\",\"res_body\"]},{\"active\":true,\"description\":\"Test regex 3\",\"regex\":\"-----BEGIN\",\"importance\":2,\"sections\":[]},{\"active\":true,\"description\":\"Test regex 4\",\"regex\":\"(?i)example\\\\.app\",\"importance\":2,\"refinerRegex\":\"[a-z\\\\-]{1,64}$\",\"sections\":[\"req_url\",\"req_headers\",\"req_body\",\"res_headers\",\"res_body\"]}]"
        );
    }
