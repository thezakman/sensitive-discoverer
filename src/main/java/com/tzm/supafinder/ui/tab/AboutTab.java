...
public class AboutTab implements ApplicationTab {
    ...
    private JPanel createPanel() {
        ...
        titleSeparator.setText("__________________________________________________________________");
        ...
        authorValueLabel.setText("TheZakMan");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        try {
            ...
            logoIcon.setIcon(new ImageIcon(logoImage.getScaledInstance(600, -1, Image.SCALE_DEFAULT)));
            logoIcon.setText("");
        ...
        githubPageButton.addActionListener(actionEvent -> {
            try {
                Desktop.getDesktop().browse(new URI("https://github.com/thezakman/SupaFinder"));
            } catch (Exception ignored) {
            }
        });
        gbc = new GridBagConstraints();
